/*
 * parser.JS POSTPROCESSOR
 * 
 * Entry point: parser_postprocessing(input, mode)
 * 
 * Arguments:
 *    • input: [array]  parser' parse tree output.
 ...
 * 
 * Return value:
 *       [string] postprocessed version of parser' output
 * 
...
/*
 * Function list:
 *   -- parser_postprocessing(text, mode)
 ...
 * Main function.
 */
function parser_postprocessing(input, mode) {
    /* Checking the input */
    ...
    } else throw "parser_postprocessing(): Invalid mode argument type!";
...
function newer_postprocessor(
    ...
    var special_selmaho = ["stem", "cmevla", "gismu", "lujvo", "fuhivla", "ga_clause",
                           "gu_clause"];
...
if (typeof module !== 'undefined') {
    module.exports.postprocessing = parser_postprocessing;
    module.exports.postprocess = parser_postprocessing;  // Alias
    ...
    if (typeof process !== 'undefined' && require !== 'undefined' && require.main === module) {
      ...
      console.log(parser_postprocessing(input, 'T'));
    }
}
